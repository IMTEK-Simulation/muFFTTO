...
domain_size = [1, 1]
nb_pix_multips = [ 2,3,4,5,6,7,8,9 ]  # ,2,3,3,2,  #,5,6,7,8,9
...
for nb_starting_phases in np.arange(np.size(nb_pix_multips)):
    ...
    for kk in np.arange(np.size(nb_pix_multips[nb_starting_phases:])):
        ...
        geometry_ID = 'sine_wave_inv'   # 'square_inclusion'#'circle_inclusion'#random_distribution
