...
for w_mult in [10., ]:  # np.arange(0.1, 1., 0.1):#[1, ]:  # np.arange(1, 2, 1):  # [2, ]:  #
    for eta_mult in [1., ]:
        ...
        def objective_function_multiple_load_cases(phase_field_1nxyz):
            ...
            for load_case in np.arange(nb_load_cases):
                ...
                if MPI.COMM_WORLD.rank == 0:
                    ...
                    print(
                        'load case ' f'{load_case},  f_sigmas_energy =' f'{f_sigmas_energy[load_case]}')
        ...
        if __name__ == '__main__':
            ...
            def apply_filter(phase):
                ...
                f_field[0, 0, np.logical_and(np.abs(discretization.fft.ifftfreq[0]) > 12,
                                             np.abs(discretization.fft.ifftfreq[1]) > 12)] = 0
                #f_field[0, 0, 12:, 24:] = 0
