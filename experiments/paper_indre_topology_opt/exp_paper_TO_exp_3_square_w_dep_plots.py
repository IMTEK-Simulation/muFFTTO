...
for w_mult in weights:
    ...
    eta_mult = 0.01
    weight = w_mult
    script_name = 'exp_paper_TO_exp_3_square' + f'_random_{random_init}' + f'_N_{N}' + f'_cgtol_{cg_tol_exponent}' + f'_soft_{soft_phase_exponent}'
...
# ax.set_aspect('equal')
ax5.set_title(r'Square grid : 2 load cases' + f' N={N}, eta={eta_mult}')
...
fname = figure_folder_path + 'exp3_square{}'.format('.pdf')
