...
parser = argparse.ArgumentParser(
    prog=script_name, description="Solve topology  problem for different target poisson ratios"
)
...
parser.add_argument("-eta", "--eta_parameter", default="0.02")
...
if __name__ == '__main__':
    ...
    apply_filter_zero_boundary(phase_field_0)
    ...
    def my_callback(result_norms):
        global iterat
        file_data_name_it = f'_eta_{eta}' + f'_w_{weight}' + f'_p_{poison_target}' + f'_iteration_{iterat}'  # print('rank' f'{MPI.COMM_WORLD.rank:6} ')
