...
parser = argparse.ArgumentParser(
    prog="exp_paper_JG_cos_time_scaling.py", description="Solve homogenization problem with cosines data"
)
...
# run iteration 10 times for better time estimates:
start_time = time.time()
elapsed_time_pure_iter = 0
for repetition in np.arange(1, 10 + 1):
