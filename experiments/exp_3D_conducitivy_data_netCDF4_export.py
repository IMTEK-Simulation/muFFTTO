...
#
for geometry_ID in  [ 'geometry_I_1_3D', 'geometry_I_2_3D', 'geometry_I_3_3D', 'geometry_I_4_3D',
    ...
    filter_par=1
    phase_field = abs(gaussian_filter(phase_field, sigma=filter_par))
    ...
    #
    # ----------------- Postprocessing ----------------------------.
    dataset_name = f'muFFTTO_{problem_type}_{geometry_ID}_N{discretization.nb_of_pixels[0]}_filt{filter_par}_all.nc'
