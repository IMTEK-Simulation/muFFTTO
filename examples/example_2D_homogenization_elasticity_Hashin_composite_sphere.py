...
for ax, (component, label) in zip(axes.flat, components):
    ...
    circle1 = plt.Circle(center, r_1, fill=False, edgecolor='black', linestyle='--', linewidth=1.5)
    circle2 = plt.Circle(center, r_2, fill=False, edgecolor='black', linestyle='-', linewidth=1.5)
